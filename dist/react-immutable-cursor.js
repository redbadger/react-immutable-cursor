...
var _default = (function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function updateAndRenderTree(newData) {
      this.setState({
        cursor: _immutableContribCursor2['default'].from(newData, this.updateAndRenderTree.bind(this))
      });
    }
  }, {
    key: 'createAtom',
    value: function createAtom() {
      ...
      return {
        cursor: _immutableContribCursor2['default'].from(_immutable2['default'].fromJS(data), this.updateAndRenderTree.bind(this))
      };
    }
  }]);
